<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $sql = "INSERT INTO plan (InitialWeight, targetWeight, startDate, dueDate, userEmail, statusID, description) 
...
<div class="container mt-5">
    <h2 class="text-center mb-4" style="color: #2c3e50; font-weight: 700;">Your Nutrition Journey</h2>
    <div class="row">
        <div class="col-md-6">
            <div class="card custom-card p-4">
                <h3 class="text-center mb-4" style="color: #2c3e50;">Set Your Goals</h3>
        ...
        <div class="col-md-6">
            <div class="progress-card">
                <h3 class="text-center mb-4" style="color: #2c3e50;">Your Progress</h3>
                <div class="text-center">
                    <div class="h4 mb-3">Weight to Lose:</div>
                    <div class="display-4 text-primary mb-4">
                        <?php 
                        if (isset($_SESSION['initialWeight']) && isset($_SESSION['targetWeight'])) {
                            echo abs($_SESSION['initialWeight'] - $_SESSION['targetWeight']) . " kg"; 
                        } else {
                            echo "Set a goal";
                        }
                        ?>
...
<div class="container mt-5 mb-5">
    <h3 class="text-center mb-4" style="color: #2c3e50;">Your Nutrition Plans</h3>
